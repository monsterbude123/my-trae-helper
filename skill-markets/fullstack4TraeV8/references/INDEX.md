...
> Agent 先读这个文件 → 2 分钟定位需要的 reference → 按需深入。

## 必读（所有 agent 工前必读）

| 文件 | 一句话 | 行数 |
|------|--------|:---:|
| minimum-knowledge.md | 每种 agent 的 MUST/ON-DEMAND/DON'T 读取表 | ~105 |
| progressive-disclosure.md | 工件体量自适应拆分规则 | ~110 |
| context-economy.md | 读文件纪律 + 汇报纪律 | ~65 |

## 按需（按功能域查）

| 功能域 | 文件 | 行数 |
|--------|------|:---:|
| 需求定位 | intake.md, proposal-template.md | ~278, ~171 |
| 规格设计 | spec-driven-development.md, spec-overlap-merge.md, roundtable.md | ~526, ~110, ~127 |
| 契约协议 | contract-first.md | ~429 |
...
| 文档管理 | doc-map-integration.md, project-structure.md | ~51, ~65 |
| 运维参考 | ops-and-e2e.md | ~25 |
| 用户指南 | ai-prompt-guide.md, vibe-coding-guide.md | ~85, ~245 |
| 版本校验 | v9-validation-protocol.md | ~321 |
