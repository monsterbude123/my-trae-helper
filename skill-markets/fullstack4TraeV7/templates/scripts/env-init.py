"""V7 Project Environment Init/Check Script (Python)
...
SKILL_TEMPLATES = Path.home() / ".trae-cn" / "builtin_skills" / "fullstack4traev7" / "templates"
...
ITEMS = [
    ...
    ("docs/prototypes/ (V7 project-level)", "docs/prototypes", "dir"),
    ("docs/test-plan/ (V7 test plan)", "docs/test-plan", "dir"),
    ("docs/CODEMAPS/", "docs/CODEMAPS", "dir"),
    ("docs/contracts/ (project-level)", "docs/contracts", "dir"),
    ("docs/archive/out/ (V7 obsoleted)", "docs/archive/out", "dir"),
    ("docs/archive/done/ (V7 completed)", "docs/archive/done", "dir"),
    ("docs/specs/config.yaml", "docs/specs/config.yaml", "file"),
    ("docs/specs/.state-card.md (V7 Cockpit)", "docs/specs/.state-card.md", "file"),
    (".trae/hooks.json", ".trae/hooks.json", "file"),
    ("scripts/debug/", "scripts/debug", "dir"),
    ("llm-prompts/ (V7 prompt snapshots)", "llm-prompts", "dir"),
]
...
TEMPLATE_MAP = {
    ...
    "docs/specs/.state-card.md (V7 Cockpit)": ("cockpit-state-card.md", False),
...
def main():
    parser = argparse.ArgumentParser(description="V7 Environment Init/Check")
    ...
    print("")
    print("# V7 Environment Check Report")
    print("")
    ...
    if missing:
        ...
        print("[OK] All items ready. V7 environment is complete.")
        print("")
