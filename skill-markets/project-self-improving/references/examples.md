...
Concrete examples of well-formatted entries covering each status and each
promotion target.
...
```markdown
## [LRN-20260822-001] best_practice

**Logged**: 2026-08-22T09:00:00Z
**Priority**: high
**Status**: promoted
**Promoted**: AGENTS.md
**Area**: backend
...
## Learning: Promoted to .trae/rules/

```markdown
## [LRN-20260823-001] best_practice

**Logged**: 2026-08-23T11:00:00Z
**Priority**: medium
**Status**: promoted
**Promoted**: .trae/rules/git.md
**Area**: infra

### Summary
Trae projects should commit `.trae/hooks.json` even when empty

### Details
A missing `.trae/hooks.json` is treated as "no hooks" by Trae, but an
explicit empty `{}` documents the project intentionally has no hooks.
This avoids false-positive self-check failures on session start.

### Suggested Action
Always include `{}` in the repo root if the project intentionally has
no hooks.

### Metadata
- Source: best_practice
- Related Files: .trae/hooks.json
- Tags: trae, hooks, project-setup
...
```markdown
## [ERR-20260825-B2C] api_timeout

**Logged**: 2026-08-25T11:30:00Z
**Priority**: critical
**Status**: pending
**Area**: backend
...
- See Also: ERR-20260820-X1Y, ERR-20260823-Z3W

---
```

> **Note the three `See Also` links** — this is the standard signal that an
> issue is recurring and likely needs systemic fix (promotion to
> `AGENTS.md` / a process change / an automation hook).
...
```markdown
## [FEAT-20260815-002] dark-mode

**Logged**: 2026-08-15T14:00:00Z
**Priority**: low
**Status**: resolved
**Area**: frontend
...
**Logged**: 2026-08-21T11:00:00Z
**Priority**: high
**Status**: promoted_to_skill
**Skill-Path**: skill-markets/docker-m1-fixes
**Area**: infra
...
- See Also: ERR-20260815-A3F, ERR-20260818-B2D
...
**File**: `skill-markets/docker-m1-fixes/SKILL.md`
