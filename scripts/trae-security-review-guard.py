#!/usr/bin/env python3
"""
scripts/trae-security-review-guard.py — trae-security-review 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/trae-security-review-guard.py trae-security-review
...
def check_trae_security_review(skill_path: str) -> dict:
    """trae-security-review 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_trae_security_review, 'structure'))
