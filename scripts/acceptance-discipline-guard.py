#!/usr/bin/env python3
"""
scripts/acceptance-discipline-guard.py — acceptance-discipline 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/acceptance-discipline-guard.py acceptance-discipline
...
def check_acceptance_discipline(skill_path: str) -> dict:
    """acceptance-discipline 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_acceptance_discipline, 'structure'))
