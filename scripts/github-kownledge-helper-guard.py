#!/usr/bin/env python3
"""
scripts/github-kownledge-helper-guard.py — github-kownledge-helper 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/github-kownledge-helper-guard.py github-kownledge-helper
...
def check_github_kownledge_helper(skill_path: str) -> dict:
    """github-kownledge-helper 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_github_kownledge_helper, 'structure'))
