#!/usr/bin/env python3
"""
scripts/browser-use-cloud-guard.py — browser-use-cloud 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/browser-use-cloud-guard.py browser-use-cloud
...
def check_browser_use_cloud(skill_path: str) -> dict:
    """browser-use-cloud 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_browser_use_cloud, 'structure'))
