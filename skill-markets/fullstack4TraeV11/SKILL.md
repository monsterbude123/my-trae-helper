...
**背景**: 任何 agent / sub-agent 在新项目初始阶段被用户/编排器叫去"建立 project rules skills",必须遵循三件套(蒸馏自全局 [`~/.trae-cn/skills/project-rule-skill/SKILL.md` §0](file:///c:/Users/septe/.trae-cn/skills/project-rule-skill/SKILL.md))。
...
铁律覆盖顺序:本 §14.1.1 三件套 > 上述 §14.1 5 项铁律(同 §11 项目级 vs 通用层优先级)
```
...
| 模板 | 用途 | 必带版本标记 |
|------|------|------------|
| [`templates/project-rules-skill-template/SKILL.md`](file:///d:/workspace/my-trae-helper/skill-markets/fullstack4TraeV11/templates/project-rules-skill-template/SKILL.md) | 新建项目时 --rules-as-skill 生成入口 | V11.8.7+ |
| [`templates/project-rules-example/README.md`](file:///d:/workspace/my-trae-helper/skill-markets/fullstack4TraeV11/templates/project-rules-example/README.md) | 占位 rule 4 件套 + 7 维 checklist | V11.8.7+ |
