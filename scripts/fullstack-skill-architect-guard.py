#!/usr/bin/env python3
"""
scripts/fullstack-skill-architect-guard.py — fullstack-skill-architect 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/fullstack-skill-architect-guard.py fullstack-skill-architect
...
def check_fullstack_skill_architect(skill_path: str) -> dict:
    """fullstack-skill-architect 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_fullstack_skill_architect, 'structure'))
