#!/usr/bin/env python3
"""
scripts/shuxia-novel-engine-guard.py — shuxia-novel-engine 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/shuxia-novel-engine-guard.py shuxia-novel-engine
...
def check_shuxia_novel_engine(skill_path: str) -> dict:
    """shuxia-novel-engine 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_shuxia_novel_engine, 'structure'))
