#!/usr/bin/env python3
"""
scripts/vibe-coding-standards-guard.py — vibe-coding-standards 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/vibe-coding-standards-guard.py vibe-coding-standards
...
def check_vibe_coding_standards(skill_path: str) -> dict:
    """vibe-coding-standards 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_vibe_coding_standards, 'structure'))
