#!/usr/bin/env python3
"""
scripts/vision-audit-guard.py — vision-audit 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/vision-audit-guard.py vision-audit
...
def check_vision_audit(skill_path: str) -> dict:
    """vision-audit 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_vision_audit, 'structure'))
