#!/usr/bin/env python3
"""
scripts/skill-bundle-guard.py — skill-bundle 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/skill-bundle-guard.py skill-bundle
...
def check_skill_bundle(skill_path: str) -> dict:
    """skill-bundle 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_skill_bundle, 'structure'))
