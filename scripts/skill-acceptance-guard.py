#!/usr/bin/env python3
"""
scripts/skill-acceptance-guard.py — skill-acceptance 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/skill-acceptance-guard.py skill-acceptance
...
def check_skill_acceptance(skill_path: str) -> dict:
    """skill-acceptance 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_skill_acceptance, 'structure'))
