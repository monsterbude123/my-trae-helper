#!/usr/bin/env python3
"""
scripts/guard-approver-guard.py — guard-approver 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/guard-approver-guard.py guard-approver
...
def check_guard_approver(skill_path: str) -> dict:
    """guard-approver 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_guard_approver, 'structure'))
