#!/usr/bin/env python3
"""
scripts/window-process-skills-guard.py — window-process-skills 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/window-process-skills-guard.py window-process-skills
...
def check_window_process_skills(skill_path: str) -> dict:
    """window-process-skills 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_window_process_skills, 'structure'))
