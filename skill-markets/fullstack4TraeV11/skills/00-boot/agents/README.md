...
## Role × Stage 履职矩阵（对照 role-protocol.md §1,V12.0.0 严格对齐 11 列；7/health 由 §13-project-health skill 接管，矩阵不显式列）

| 角色 \ Stage | -1 | 0/0.5 | 1 | 1.5 | 2 | 3 | 3.5 | 4 | 4.5/5 | 6 |
|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| 贾维斯 | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate | ✅全域 gate |
...
> **2026-08-18 V12.0.0 修**:本矩阵严格对齐 role-protocol.md §1 的 11 列。原 V12.0.0 多出的 `7/health` 列 = orphan(主代理直改 — §1.11 豁免范围)。`7/health` 协作见 [skills/13-project-health/SKILL.md](../../13-project-health/SKILL.md)。
