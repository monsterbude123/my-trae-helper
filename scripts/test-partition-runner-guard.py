#!/usr/bin/env python3
"""
scripts/test-partition-runner-guard.py — test-partition-runner 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/test-partition-runner-guard.py test-partition-runner
...
def check_test_partition_runner(skill_path: str) -> dict:
    """test-partition-runner 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_test_partition_runner, 'structure'))
