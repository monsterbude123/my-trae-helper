#!/usr/bin/env python3
"""
scripts/trae-local-data-export-guard.py — trae-local-data-export 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/trae-local-data-export-guard.py trae-local-data-export
...
def check_trae_local_data_export(skill_path: str) -> dict:
    """trae-local-data-export 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_trae_local_data_export, 'structure'))
