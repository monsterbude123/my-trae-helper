#!/usr/bin/env python3
"""
scripts/test-experience-guard.py — test-experience 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/test-experience-guard.py test-experience
...
def check_test_experience(skill_path: str) -> dict:
    """test-experience 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_test_experience, 'structure'))
