#!/usr/bin/env python3
"""
scripts/skill-creator-claude-guard.py — skill-creator-claude 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/skill-creator-claude-guard.py skill-creator-claude
...
def check_skill_creator_claude(skill_path: str) -> dict:
    """skill-creator-claude 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_skill_creator_claude, 'structure'))
