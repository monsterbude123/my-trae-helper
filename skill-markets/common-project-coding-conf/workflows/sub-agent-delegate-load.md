...
- 来源: common-project-coding-conf v1.0（references/agent-delegate-protocol.md，迁移自 project-rules-gate v0.2）
- 衍生: fullstack4TraeV11 [PROJECT-RULES-GATE] 块（同名同协议）
- 适用范围: 任何项目，任何 sub-agent 类型

---

*由 common-project-coding-conf 锻造器自动复制到 .trae/skills/project_rules_skills/workflows/*
