...
### 7. 委派注入模板（V10.8 升级 — 迁移至 SKILL.md §1.5.0）

> 委派注入的强制头部模板和场景化决策已迁移至 [SKILL.md §1.5.0](../SKILL.md)。
...
## 自检清单（V10.8 — 委派前判断已迁移至 SKILL.md §1.5.0）

> 委派前的"是否注入"判断已在 SKILL.md §1.5.0 场景化决策表中覆盖。
> 本清单仅保留子代理返回后的验证项。
