#!/usr/bin/env python3
"""
scripts/session-distiller-guard.py — session-distiller 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/session-distiller-guard.py session-distiller
...
def check_session_distiller(skill_path: str) -> dict:
    """session-distiller 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_session_distiller, 'structure'))
