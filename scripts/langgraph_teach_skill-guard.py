#!/usr/bin/env python3
"""
scripts/langgraph_teach_skill-guard.py — langgraph_teach_skill 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/langgraph_teach_skill-guard.py langgraph_teach_skill
...
def check_langgraph_teach_skill(skill_path: str) -> dict:
    """langgraph_teach_skill 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_langgraph_teach_skill, 'structure'))
