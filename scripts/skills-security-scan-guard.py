#!/usr/bin/env python3
"""
scripts/skills-security-scan-guard.py — skills-security-scan 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/skills-security-scan-guard.py skills-security-scan
...
def check_skills_security_scan(skill_path: str) -> dict:
    """skills-security-scan 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_skills_security_scan, 'structure'))
