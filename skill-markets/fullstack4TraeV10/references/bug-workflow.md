...
> 来源: test-other-dev 86237 蒸馏。Bug 修复时主上下文靠"记忆找模板"，探索性读取占总耗时 ~15%。
...
> 来源: test-other-dev 4 Phase 流程蒸馏。每阶段交接需主上下文做交接验证，避免产物漂移。
...
## 跨层修复最小化范式（V10.8 补丁 — 86192 蒸馏）

> 来源: test-other-dev 86192。字段缺失时 crawler+router+parser+schema 4 层全改 80+ 行，DRIFT FAIL。
...
> 来源: test-other-dev bug-fix-workflow。修复前先考虑不修复/最小修复。
