#!/usr/bin/env python3
"""
scripts/coding-xinfa-guard.py — coding-xinfa 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/coding-xinfa-guard.py coding-xinfa
...
def check_coding_xinfa(skill_path: str) -> dict:
    """coding-xinfa 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_coding_xinfa, 'structure'))
