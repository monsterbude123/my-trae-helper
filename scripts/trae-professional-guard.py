#!/usr/bin/env python3
"""
scripts/trae-professional-guard.py — trae-professional 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/trae-professional-guard.py trae-professional
...
def check_trae_professional(skill_path: str) -> dict:
    """trae-professional 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_trae_professional, 'structure'))
