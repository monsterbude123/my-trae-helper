#!/usr/bin/env python3
"""
scripts/openapi-doc-exporter-guard.py — openapi-doc-exporter 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/openapi-doc-exporter-guard.py openapi-doc-exporter
...
def check_openapi_doc_exporter(skill_path: str) -> dict:
    """openapi-doc-exporter 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_openapi_doc_exporter, 'structure'))
