#!/usr/bin/env python3
"""
scripts/ponytail4Trae-guard.py — ponytail4Trae 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/ponytail4Trae-guard.py ponytail4Trae
...
def check_ponytail4Trae(skill_path: str) -> dict:
    """ponytail4Trae 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_ponytail4Trae, 'structure'))
