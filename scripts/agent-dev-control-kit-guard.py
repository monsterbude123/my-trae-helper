#!/usr/bin/env python3
"""
scripts/agent-dev-control-kit-guard.py — agent-dev-control-kit 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/agent-dev-control-kit-guard.py agent-dev-control-kit
...
def check_agent_dev_control_kit(skill_path: str) -> dict:
    """agent-dev-control-kit 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_agent_dev_control_kit, 'structure'))
