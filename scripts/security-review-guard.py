#!/usr/bin/env python3
"""
scripts/security-review-guard.py — security-review 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/security-review-guard.py security-review
...
def check_security_review(skill_path: str) -> dict:
    """security-review 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_security_review, 'structure'))
