#!/usr/bin/env python3
"""
scripts/modelscope-assistant-guard.py — modelscope-assistant 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/modelscope-assistant-guard.py modelscope-assistant
...
def check_modelscope_assistant(skill_path: str) -> dict:
    """modelscope-assistant 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_modelscope_assistant, 'structure'))
