#!/usr/bin/env python3
"""
scripts/deep-research-guard.py — deep-research 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/deep-research-guard.py deep-research
...
def check_deep_research(skill_path: str) -> dict:
    """deep-research 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_deep_research, 'structure'))
