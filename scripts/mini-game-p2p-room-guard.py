#!/usr/bin/env python3
"""
scripts/mini-game-p2p-room-guard.py — mini-game-p2p-room 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/mini-game-p2p-room-guard.py mini-game-p2p-room
...
def check_mini_game_p2p_room(skill_path: str) -> dict:
    """mini-game-p2p-room 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_mini_game_p2p_room, 'structure'))
