...
SKILL_TEMPLATES = Path.home() / ".trae-cn" / "skills" / "fullstack4TraeV10" / "templates"
    ...
    if missing:
        ...
        if args.fix:
            ...
            if missing_hooks:
                ...
                print("")
                print("```")
                print("python ~/.trae-cn/skills/fullstack4TraeV10/scripts/install-hooks.py --project-root .")
                print("```")
                print("")
    else:
