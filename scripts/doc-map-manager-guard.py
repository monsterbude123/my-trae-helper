#!/usr/bin/env python3
"""
scripts/doc-map-manager-guard.py — doc-map-manager 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/doc-map-manager-guard.py doc-map-manager
...
def check_doc_map_manager(skill_path: str) -> dict:
    """doc-map-manager 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_doc_map_manager, 'structure'))
