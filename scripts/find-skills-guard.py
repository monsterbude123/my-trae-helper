#!/usr/bin/env python3
"""
scripts/find-skills-guard.py — find-skills 专属守卫（2026-08-18 guard-smith 委派生成）
...
用法:
  python scripts/find-skills-guard.py find-skills
...
def check_find_skills(skill_path: str) -> dict:
    """find-skills 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_find_skills, 'structure'))
