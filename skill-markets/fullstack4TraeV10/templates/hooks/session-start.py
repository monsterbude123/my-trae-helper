...
V10.1 变更:
  - 检测 .specify/constitution.md + v10_simplified 标记
...
constitution = project_root / ".specify" / "constitution.md"
if constitution.exists():
    try:
        text = constitution.read_text(encoding="utf-8")
        if "v10_simplified" in text:
            print("  ✅ .specify/constitution.md + v10_simplified 标记 — V10 满分硬门禁生效")
        else:
            print("  ⚠️ .specify/constitution.md 存在但缺 v10_simplified 标记")
    except Exception:
        print("  ⚠️ .specify/constitution.md 存在但无法读取")
else:
    print("  ⚠️ .specify/constitution.md missing — V10 硬门禁未初始化")
