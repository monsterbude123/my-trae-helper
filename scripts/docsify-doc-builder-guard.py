#!/usr/bin/env python3
"""
scripts/docsify-doc-builder-guard.py — docsify-doc-builder 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/docsify-doc-builder-guard.py docsify-doc-builder
...
def check_docsify_doc_builder(skill_path: str) -> dict:
    """docsify-doc-builder 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_docsify_doc_builder, 'structure'))
