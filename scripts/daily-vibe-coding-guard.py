#!/usr/bin/env python3
"""
scripts/daily-vibe-coding-guard.py — daily-vibe-coding 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/daily-vibe-coding-guard.py daily-vibe-coding
...
def check_daily_vibe_coding(skill_path: str) -> dict:
    """daily-vibe-coding 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_daily_vibe_coding, 'structure'))
