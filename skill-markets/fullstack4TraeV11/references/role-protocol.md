# Role Protocol — 角色协议（V12.0.0 已授权 — 主版本升级后强制）

> **状态**: V12.0.0 已授权（用户 2026-08-16 "同意 A"），落地路线图见 §9
...
**V11 兼容(已永久废弃,V11.8.7.1)**: V11 扁平布局的角色产物落位规则不变 → **V11 扁平布局已永久废弃,所有项目必须 V12 多卡 + fact/ + stage/{N}/ 物理布局**。V11.8.6 §7.5 已在 4 个 agents 文件落地,V12.0.0 升为强制默认行为。
