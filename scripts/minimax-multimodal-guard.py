#!/usr/bin/env python3
"""
scripts/minimax-multimodal-guard.py — minimax-multimodal 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/minimax-multimodal-guard.py minimax-multimodal
...
def check_minimax_multimodal(skill_path: str) -> dict:
    """minimax-multimodal 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_minimax_multimodal, 'structure'))
