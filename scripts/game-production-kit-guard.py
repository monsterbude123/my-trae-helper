#!/usr/bin/env python3
"""
scripts/game-production-kit-guard.py — game-production-kit 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/game-production-kit-guard.py game-production-kit
...
def check_game_production_kit(skill_path: str) -> dict:
    """game-production-kit 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_game_production_kit, 'structure'))
