#!/usr/bin/env python3
"""
scripts/learn-plan-skill-guard.py — learn-plan-skill 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/learn-plan-skill-guard.py learn-plan-skill
...
def check_learn_plan_skill(skill_path: str) -> dict:
    """learn-plan-skill 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_learn_plan_skill, 'structure'))
