#!/usr/bin/env python3
"""
scripts/meeting-minutes-taker-guard.py — meeting-minutes-taker 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/meeting-minutes-taker-guard.py meeting-minutes-taker
...
def check_meeting_minutes_taker(skill_path: str) -> dict:
    """meeting-minutes-taker 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_meeting_minutes_taker, 'structure'))
