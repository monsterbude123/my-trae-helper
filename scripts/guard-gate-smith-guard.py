#!/usr/bin/env python3
"""
scripts/guard-gate-smith-guard.py — guard-gate-smith 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/guard-gate-smith-guard.py guard-gate-smith
...
def check_guard_gate_smith(skill_path: str) -> dict:
    """guard-gate-smith 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_guard_gate_smith, 'structure'))
