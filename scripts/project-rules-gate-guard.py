#!/usr/bin/env python3
"""
scripts/project-rules-gate-guard.py — project-rules-gate 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/project-rules-gate-guard.py project-rules-gate
...
def check_project_rules_gate(skill_path: str) -> dict:
    """project-rules-gate 专属守卫 — 组合 2 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_project_rules_gate, 'structure'))
