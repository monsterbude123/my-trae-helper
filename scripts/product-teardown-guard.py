#!/usr/bin/env python3
"""
scripts/product-teardown-guard.py — product-teardown 专属守卫（2026-08-14 拆分方案 A 自动生成）
...
用法:
  python scripts/product-teardown-guard.py product-teardown
...
def check_product_teardown(skill_path: str) -> dict:
    """product-teardown 专属守卫 — 组合 1 个 aspect 的检查结果.
...
if __name__ == '__main__':
    sys.exit(cli_main(check_product_teardown, 'structure'))
